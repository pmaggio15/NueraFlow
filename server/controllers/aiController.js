...
//         console.log('ClipDrop API Key first 10 chars:', process.env.CLIPDROP_API_KEY?.substring(0, 10));
...
// //Generate image with ClipDrop + Cloudinary
...
//     } catch (error) {
//         console.log('ClipDrop Error:', error.message);
        
//         if (error.response?.status === 402) {
//             return res.json({
//                 success: false, 
//                 message: "Payment required. Please check your ClipDrop account billing."
//             });

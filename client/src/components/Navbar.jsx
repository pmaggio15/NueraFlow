...
const Navbar = () => {
    ...
    return (
        <div className='fixed z-50 w-full bg-white/10 backdrop-blur-md border-b border-white/20 flex justify-between items-center py-3 sm:py-4 px-4 sm:px-8 xl:px-16'>
            <img 
                src={assets.logo} 
                alt="logo" 
            ...
            {isLoaded && ( // Only render when user data is loaded
                user ? (

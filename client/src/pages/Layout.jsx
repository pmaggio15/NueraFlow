...
//       <div className='relative z-10 flex flex-col h-screen pt-16'> {/* Added pt-16 for navbar space */}
...
//               <div className='bg-white/90 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl min-h-[calc(100vh-150px)] p-6 md:p-8'>
//                 <Outlet />
//               </div>
//             </div>
//           </div>
